"""StockStalker v2 — config → LLM bridge (spec §4.11).
...
Not exported from ``stockstalker.llm.__init__`` on purpose — importing it pulls
config (and thus requires a valid .env), whereas ``import stockstalker.llm`` stays
lightweight. Import it explicitly: ``from stockstalker.llm.builder import build_llms``.
"""
from typing import Any

from stockstalker.config import settings as _settings
