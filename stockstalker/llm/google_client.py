"""StockStalker v2 — native Google Gemini client (langchain-google-genai).

Maps StockStalker's unified options to Gemini params: ``api_key`` (or GEMINI_API_KEY
...
from stockstalker.llm.api_key_env import get_api_key_env
from stockstalker.llm.base_client import BaseLLMClient, normalize_content
from stockstalker.llm.validators import validate_model
