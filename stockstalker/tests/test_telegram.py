"""StockStalker — Telegram component unit tests (mocked; NO real Telegram calls).
...
@pytest.fixture
def bot(monkeypatch):
    """A StockStalkerBot built with a fake token (no network) + a stub runner."""
