"""QuantMind v2 — interactive menu (TUI) built on rich + questionary.

Launched by running ``quantmind`` (or ``python quantmind/main.py``) with NO
...
| (_) | || / _` | ' \ |  _| |\/| | | ' \/ _` |
 \__\_\\_,_\__,_|_||_| \__|_|  |_|_|_||_\__,_|
"""
