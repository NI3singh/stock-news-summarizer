...
/**
 * StockStalker AI mark — a rising chart line locked onto a tactical reticle.
 * Copied 1:1 from the app's logo so the video is brand-accurate.
 */
export const LogoMark: React.FC<{ size?: number; style?: React.CSSProperties }> = ({
  ...
  >
    ...
    <path
      d="M4 52 L10 47 L18 49 L26 39 L34 42 L44 16"
      stroke="url(#cL)"
      strokeWidth="3"
      strokeLinecap="round"
